const verifyEmail = {
  ja: {
    ...
    message: token => {
      ...
      <p><a target="_blank" href="https://api.cA.com/users/activate/${token}">https://api.peer8.com/users/activate/${token}</a></p>
...
const resetPassword = {
  ja: {
    ...
    message: (user, token) => {
      ...
      <p><a target="_blank" href="https://api.cA.com/auth/resetPassword?t=${token}">https://api.peer8.com/auth/resetPassword?t=${token}</a></p>
